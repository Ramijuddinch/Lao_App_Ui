...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__registration__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_services_loader__ = __webpack_require__(109);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_services_services__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Datahandler_datahandler__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_storage__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_services_alert_service__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_services_toast__ = __webpack_require__(222);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegistrationPage = /** @class */ (function () {
    function RegistrationPage(navCtrl, _alert, Toast, serviceHandler, storage, events, navParams, loader, dataHandler) {
        var _this = this;
    ...
    RegistrationPage.prototype.registrationData = function () {
        var _this = this;
        ...
        if (this.registrationModel.password != this.registrationModel.conpassword) {
            ...
            this.serviceHandler.Add_Retailers(data).then(function (response) {
                _this.loader.show();
                if (response['code'] == 200) {
                    // this.dataHandler.storage.set('mobile', this.mobile);
                    // this.events.publish('mobile', this.mobile);
                    _this.Toast.show('Record insert successfully');
    ...
    RegistrationPage.prototype.getAllLanguange = function () {
        var _this = this;
        this.serviceHandler.Get_All_Languanges().then(function (response) {
            _this.allLanguages = response['message'];
        });
    };
    RegistrationPage.prototype.switchlang = function (langcode) {
        this.langCode = __WEBPACK_IMPORTED_MODULE_7_lodash__["find"](this.allLanguages, { '_id': langcode });
        this.dataHandler.storage.set('selectedLanguages', this.langCode);
    };
    RegistrationPage.prototype.getAllWholesalers = function () {
        var _this = this;
        this.serviceHandler.Get_All_Wholesalers().then(function (response) {
            _this.allWholesalers = response['message'];
        });
    };
    RegistrationPage.prototype.switchWholesaler = function (Wholesaler) {
        this.selectWholesaler = __WEBPACK_IMPORTED_MODULE_7_lodash__["filter"](this.allWholesalers, { '_id': Wholesaler });
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42), __webpack_require__(357)(module)))
